<x-app-layout>
    <div class="my-5 ml-10 sm:my-5 sm:mx-5 py-[2px] bg-yellow-500 sm:w-[20%] text-center shadow-md rounded-md">
        <h3 class="font-bold text-xl uppercase">Add New Payment Spp</h3>
    </div>
    @if (Route::has('login'))
    @auth
    ...
    @endif
        ...
        <div class="md:flex md:items-center mb-6 ml-6">
          <div class="md:w-1/3">
            ...
            <div class="md:w-2/3">
                <input readonly class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500 shadow-md" id="code_id" name="code_id" type="text"
                value="1">
            <x-input-error class="mt-2" :messages="$errors->get('code_id')" />
          </div>
        </div>
        <div class="md:flex md:items-center mb-6">
          ...
          <div class="md:w-2/3">
            ...
            <option disabled selected class="disabled:bg-slate-700 disabled:text-slate-100">-- Select Petugas --</option>
                @foreach ($pe as $arr)
                    @if ($arr->level_id === 1)
                        <option class="bg-slate-100" value="{{ $arr->id }}">{{ $arr->nama_petugas }}</option>
                    @elseif($arr->level_id === 2)
                    <option class="bg-slate-100" value="{{ $arr->id }}">{{ $arr->nama_petugas }}</option>
                    @else
        ...
        <div class="md:flex md:items-center mb-6">
          ...
          <div class="md:w-2/3">
            ...
            <option disabled selected class="disabled:bg-slate-700 disabled:text-slate-100">-- Siswa / Nisn --</option>
                @foreach ($sis as $arr)
                    <option class="bg-slate-100" value="{{ $arr->nisn }}">{{ $arr->nama }} / {{ $arr->nisn }}</option>
                @endforeach
            </select>
        ...
        <div class="md:flex md:items-center mb-6">
            ...
            <div class="md:w-2/3">
              <input class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500 shadow-md" id="tgl_bayar" name="tgl_bayar" type="date">
          ...
          <div class="md:w-2/3">
            ...
            <option disabled class="disabled:bg-slate-700 disabled:text-slate-100">-- Select SPP Tahunan --</option>
                @foreach ($sp as $arr)
                    <option class="bg-slate-100" value="{{ $arr->id }}">{{ $arr->tahun}} /  {{ toRupiah($arr->nominal)}}</option>
                @endforeach
            </select>
        ...
        <div class="md:flex md:items-center mb-6">
            ...
            <div class="md:w-2/3 flex rounded-md shadow-md">
              ...
              <input class="bg-gray-200 appearance-none border-r-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" id="uang_bayar" name="uang_bayar" type="text" placeholder="200000">
        ...
        <div class="md:flex md:items-center mb-6">
            ...
            <div class="md:w-2/3 flex rounded-md shadow-md">
              <span class="px-4 inline-flex items-center min-w-fit rounded-l-md border border-r-0 border-gray-200 bg-gray-100 text-sm text-black dark:bg-gray-700 dark:border-gray-700 dark:text-gray-400">Rp.</span>
              <input class="bg-gray-200 appearance-none border-r-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" id="jumlah_bayar" name="jumlah_bayar" type="text" placeholder="170000">
        ...
        <div class="md:flex md:items-center mb-6">
            ...
            <div class="md:w-2/3 flex rounded-md shadow-md">
              <span class="px-4 inline-flex items-center min-w-fit rounded-l-md border border-r-0 border-gray-200 bg-gray-100 text-sm text-black dark:bg-gray-700 dark:border-gray-700 dark:text-gray-400">Rp.</span>
               <input class="bg-gray-200 appearance-none border-r-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" id="kembalian_bayar" name="kembalian_bayar" type="text" placeholder="30000" readonly="">
          ...
          <div class="md:flex md:items-center mb-6">
            ...
            <div class="md:w-2/3 flex rounded-md shadow-md">
              <input class="bg-gray-200 appearance-none border-r-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" id="keterangan" name="keterangan" type="text" placeholder="Belum Lunas" value="Belum Lunas" readonly>
          ...
          <div class="md:flex md:items-center mb-6">
            ...
            <div class="md:w-2/3 flex rounded-md shadow-md">
              <input class="bg-gray-200 appearance-none border-r-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" id="lain-lain" name="lain-lain" type="text" placeholder="-">
              <x-input-error class="mt-2" :messages="$errors->get('lain-lain')" />
            </div>
          </div>
