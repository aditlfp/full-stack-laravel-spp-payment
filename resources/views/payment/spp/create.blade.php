    ...
    @endif
        ...
        <div class="md:flex md:items-center mb-6">
          ...
          <div class="md:w-2/3">
            ...
            <option disabled selected class="disabled:bg-slate-700 disabled:text-slate-100">-- Select SPP Tahunan --</option>
                @foreach ($sp as $arr)
        ...
        <div class="md:flex md:items-center mb-6">
          ...
          <div class="md:flex md:items-center mb-6">
            ...
            <div class="md:w-2/3 flex rounded-md shadow-md">
              <input class="bg-gray-200 appearance-none border-r-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" id="keterangan" name="keterangan" type="text" placeholder="Belum Lunas" value="Belum Lunas">
