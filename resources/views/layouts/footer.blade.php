<footer class="px-4 pt-20 pb-8 text-white bg-black">
    <div class="hidden sm:block lg:block container flex flex-col justify-between max-w-6xl px-4 mx-auto overflow-hidden lg:flex-row">
            <a href="#_" class="block w-1/3 mr-4">
                <span class="flex items-center">
                    ...
                    <span class="ml-2 text-lg font-black">Spp Payment</span>
                </span>
            </a>
        <div class="block w-2/3 mt-6 text-sm sm:flex lg:mt-0">
            ...
            <div class="flex flex-col w-full text-gray-700">
                ...
                <div class="flex justify-start pl-4 mt-2">
                    <a class="flex items-center block mr-6 text-gray-300 no-underline hover:text-white" target="_blank" rel="noopener noreferrer" href="#">
                    ...
                    <a class="flex items-center block text-gray-300 no-underline hover:text-white" target="_blank" rel="noopener noreferrer" href="https://github.com/aditlfp">
                        <svg viewBox="0 0 24 24" class="w-5 h-5 fill-current" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="pt-4 pt-6 mt-10 text-center text-gray-600 border-t border-gray-800"> ©2023 Aditya_SppPayment. All rights reserved.</div>
</footer>
