<nav x-data="{ open: false }" class="w-full fixed top-0 z-50 bg-white border-b border-gray-100">
    <!-- Primary Navigation Menu -->
    <div class="relative w-full h-24 px-8 pt-2 bg-white">
        ...
        <div class="container flex items-center justify-between h-full max-w-6xl mx-auto">
            <a href="#_" class="relative flex items-center inline-block h-5 h-full font-black">
                ...
                <span class="ml-3 text-2xl font-black hidden sm:block">SPP Payment</span>
            </a>
