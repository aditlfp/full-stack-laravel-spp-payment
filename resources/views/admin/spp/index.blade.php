            ...
            <tbody>
              ...
              @foreach( $spp as $s)
                <tr>
                  ...
                  <td class="border px-4 py-2">{{ toRupiah($s->nominal)}}</td>
                  <td class="border px-4 py-2">
                    <div class="flex gap-2">
                        <a href="{{ url('/admin/cspp/'.$s->id. '/edit')}}" class="bg-[#FFED00] px-3 py-1 rounded text-lg hover:bg-amber-300 transition all ease-out duration-100"><i class="ri-edit-box-line"></i>
                        </a>
